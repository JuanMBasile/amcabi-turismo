...
/**
 * Destination Detail Error Boundary
 *
 * Displays when there's an error loading a destination.
    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="font-display font-black text-ink text-2xl md:text-3xl mb-4">
          No pudimos cargar este destino
        </h1>
        <p className="font-body text-ink-muted text-base mb-8 leading-relaxed">
          Ocurrio un error al cargar la informacion del destino. Por favor, intenta de nuevo
          o explora otros destinos disponibles.
        </p>
        ...
        <div className="mt-10 pt-8 border-t border-border">
          ...
          <a
            href="https://wa.me/5491162203682?text=Hola!%20Quiero%20informacion%20sobre%20paquetes%20turisticos."
            target="_blank"
