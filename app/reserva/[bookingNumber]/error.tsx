...
/**
 * Booking Confirmation Error Boundary
 *
 * Displays when there's an error loading the booking confirmation.
 */
    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="font-body text-ink-muted text-base mb-8 leading-relaxed">
          El numero de reserva puede ser incorrecto o la reserva no existe en nuestro sistema.
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            ...
            aria-label="Buscar otra reserva"
          >
            Buscar reserva
          </Link>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-border">
          ...
          <a
            href="https://wa.me/5491162203682?text=Hola!%20Necesito%20ayuda%20para%20encontrar%20mi%20reserva."
            target="_blank"
