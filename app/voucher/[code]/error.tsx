...
/**
 * Voucher Error Boundary
 *
 * Displays when there's an error loading the voucher.
 */
export default function VoucherError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Error en voucher:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="font-body text-ink-muted text-base mb-8 leading-relaxed">
          El codigo de voucher puede ser incorrecto o el voucher no existe en nuestro sistema.
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            ...
            aria-label="Buscar otro voucher"
          >
            Buscar voucher
          </Link>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-border">
          <p className="font-body text-ink-faint text-sm mb-3">
            ¿Necesitas tu voucher?
          </p>
          <a
            href="https://wa.me/5491162203682?text=Hola!%20Necesito%20ayuda%20para%20obtener%20mi%20voucher."
            target="_blank"
