 ...
 *
 * Displays when there's an error loading the booking form.
 */
    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="font-body text-ink-muted text-base mb-8 leading-relaxed">
          Ocurrio un error al cargar el formulario de reserva. La salida puede no estar disponible
          o hubo un problema de conexion. Por favor, intenta de nuevo.
        </p>
        ...
        <div className="mt-10 pt-8 border-t border-border">
          ...
          <a
            href="https://wa.me/5491162203682?text=Hola!%20Quiero%20reservar%20un%20paquete%20turistico."
            target="_blank"
